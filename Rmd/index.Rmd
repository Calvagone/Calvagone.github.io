...
e-Campsis is an application that provides an intuitive and user-friendly interface for setting up population PK/PD simulations. Discover [e-Campsis](./ecampsis.html) here or check out our [documentation](https://calvagone.github.io/ecampsis.doc/).
...
Campsistrans is dedicated to importing models from a variety of sources. Currently, it imports your models from NONMEM control files (including parameter estimates and variance-covariance matrix), Monolix, and rxode2.
