...
1. **Installation**: An docker image of e-Campsis and the Campsis suite is made before every release.
...
For illustration, the quality assessment of the Campsis suite is shown below:

![](images/package_quality_assessment.png){width=75%}

## Online GitHub repositories

All the Campsis packages are hosted on GitHub. The source code of the Campsis suite is available at [github.com/Calvagone](https://github.com/Calvagone/).
