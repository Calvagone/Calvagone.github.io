...
e-Campsis itself is not validated, as it merely provides a graphical user interface that facilitates the set-up of simulations. The actual *work* is done by the open-source packages campsis and campsismod in the background. Simulations of almost all library models with campsis - which uses mrgsolve or rsxode2 as the back-end simulation engine - have been successfully verified against simulations with NONMEM. 
