...
::: card-body
Same as features as in free plus:
...
A beta version will be available in Q4 this year. Stay tuned and meanwhile enjoy the free versions of e-Campsis!
...
### Is E-campsis validaded ?
E-campsis itself is not validated, as it merely provides a graphical user interface that facilitates the set-up of simulations. The actual *work* is done by the open-source packages campsis and campsismod in the background. Simulations of almost all library models with campsis - which uses mrgsolve or rsxode2 as the back-end simulation engine - have been successfully validated against simulations with NONMEM. 
In addition users of e-Campsis pro will have the option to obtain an installation qualification suite to ensure accurate functioning of campsis and campismod in their local environment.

### How can I implement more complex dosing regimens including, e.g. a loading dose ?
This can be done via the 'Custom dataset' option in the trial design tab. There you can directly provide campsis code in of more complex dosing and observation regimens. Have a look at https://calvagone.github.io/campsis.doc/articles/v01_dataset.html for instructions how to do it.

### When can I buy the pro version ? How much will it cost ?
The beta pro-version will be available very soon. It will be a annual subscription per named user. The price will be announced with on the date of the release. Early bird beta-users will get a discount of 50% !

### Will there be a discount for academia ?
Yes, for the purpose of research there will be a significant discount. For teaching we think that the free version should already cover your needs. If not let us know.
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/uypETm6aoNc" frameborder="0" allowfullscreen>
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/M_LLI_poS2E" frameborder="0" allowfullscreen>
...
<iframe width="560" height="315" src="https://www.youtube.com/embed/Oq9PBJ7v-yQ" frameborder="0" allowfullscreen>
