...
A beta version will be available in Q4 this year.
Stay tuned and meanwhile enjoy the free versions of e-Campsis!
...
The actual "work" is done by the open-source packages *campsis* and *campsismod* in the background.
...
This can be done via the 'Custom dataset' option in the trial design tab.
There you can directly provide campsis code in of more complex dosing and observation regimens.
Have a look at <https://calvagone.github.io/campsis.doc/articles/v01_dataset.html> for instructions how to do it.

### When can I buy the pro version ? How much will it cost ?

The beta pro-version will be available very soon.
It will be a annual subscription per named user.
The price will be announced with on the date of the release.
Early bird beta-users will get a discount of 50% !

### Will there be a discount for academia ?

Yes, for the purpose of research there will be a significant discount.
